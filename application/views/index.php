  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">"Your Fast Track, <br> To career Success!"</span>
    ...
    <div class="forms">
        <div class="form-content">
          ...
          <form action="<?php echo site_url("welcome/loginSign");?>" method="post">
        ...
        <form action="<?php echo site_url("accueilController/beMember");?>" method="post">
            <div class="input-boxes">
              <div class="input-box">
